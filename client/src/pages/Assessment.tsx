                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-accent/50 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 transition-colors cursor-pointer">
                      <RadioGroupItem value="not-sure" id="not-sure" tabIndex={0} />
                    ...
                    {/* Half Day */}
                    <div className="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-accent/50 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 transition-colors cursor-pointer">
                      <RadioGroupItem value="half-day" id="half-day" tabIndex={0} />
                    ...
                    {/* Full Day */}
                    <div className="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-accent/50 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 transition-colors cursor-pointer">
                      <RadioGroupItem value="full-day" id="full-day" tabIndex={0} />
                    ...
                    {/* Month-Long */}
                    <div className="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-accent/50 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 transition-colors cursor-pointer">
                      <RadioGroupItem value="month-long" id="month-long" tabIndex={0} />
